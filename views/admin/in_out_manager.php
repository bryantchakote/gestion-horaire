...
if(isset($_SESSION['selected-date']) && !empty($_SESSION['selected-date'])) $selectedDate = true;
...
<html>
  ...
  <body class="w3-content w3-light-grey">
        ...
        <form method="post" action="../../models/actions.php" id="actions" class="w3-row-padding w3-padding-large w3-center">
          ...
          <table class="w3-table-all w3-centered w3-hoverable w3-margin-top w3-margin-bottom">
            ...
            <tr class="std<?php echo $i ?>-list">
              ...
              <td><input type="time" name="in<?php echo $lvlStudentsResult['id_pers'] ?>"></td>
              <td><input type="time" name="out<?php echo $lvlStudentsResult['id_pers'] ?>"></td>
              <?php
              }
              ?>
            </tr>
            ...
            <tr class="ens-list">
              ...
              <td><input type="time" name="in<?php echo $ensResult['id_pers'] ?>"></td>
              <td><input type="time" name="out<?php echo $ensResult['id_pers'] ?>"></td>
              <?php
              }
              ?>
            </tr>
            ...
            <tr class="stf-list">
              ...
              <td><input type="time" name="in<?php echo $staffResult['id_pers'] ?>"></td>
              <td><input type="time" name="out<?php echo $staffResult['id_pers'] ?>"></td>
              <?php
              }
              ?>
            </tr>
    ...
    <script>
      ...
      var inOutDay = document.getElementById('in-out-day');
      inOutDay.addEventListener("change", function(){actions.submit()});
